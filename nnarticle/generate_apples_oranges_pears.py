...
avg_pear_weight = 160 # gram

centers = [[avg_orange_weight, avg_orange_diameter], [avg_apple_weight, avg_apple_diameter], [avg_pear_weight, avg_pear_diameter]]

X, y = make_blobs([30] * len(centers), centers, [[6,1]] * len(centers))
